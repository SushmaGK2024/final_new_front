...
const Sidebar = (props) => {
  ...
  return (
    <div style={{ position: 'fixed', width: '100%', display: 'flex', justifyContent: 'space-around', zIndex: dropdownZIndex , background:'white' , height:'80px', flexDirection:"row"}}>
      <div class="dropdown">
      ...
      <div className='placify-icon'>
      <img src="/placify-logo.gif" alt="Profile" />
      </div>
